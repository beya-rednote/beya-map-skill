...
def build_prompts(country_zh: str, country_en: str, area_zh: str, area_en: str) -> str:
    style = shared_style()
...
def main() -> int:
    ...
    print(build_prompts(country_zh, country_en, area_zh, area_en))
    return 0
